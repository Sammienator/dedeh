...
const YouTubeVideoComponent = () => {
  ...
  return (
    <div id='yout' className="flex flex-col items-center mt-10 mb-10">

<h1 data-aos="fade-down" data-aos-easing="linear"
     data-aos-duration="2000" class="sm:text-4xl text-3xl font-medium  rounded-lg title-font mb-4 text-black"> Stream my Music. </h1>
     
      <iframe  className="justify-center p-4 rounded-lg m-4" width="560" height="315" src="https://www.youtube.com/embed/ZjNx0d4LSvg?si=j8fkH65ntGK74jrL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
